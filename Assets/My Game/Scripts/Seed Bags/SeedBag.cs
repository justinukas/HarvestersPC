...
namespace Main.SeedBags
{
    public class SeedBag : MonoBehaviour
    {
        ...
        // gets called by ToolInteractions
        public void PlantingRaycast()
        {
            ...
            {
                if (Physics.Raycast(ray, out RaycastHit hit, 1.5f, Grabbables) && hit.collider.CompareTag("TilledDirt"))
                {
        ...
        private void ChangeColor()
        {
            ...
            var bagMaterials = gameObject.transform.Find($"{bagVariant} Seed Bag").GetComponent<Renderer>().materials;
